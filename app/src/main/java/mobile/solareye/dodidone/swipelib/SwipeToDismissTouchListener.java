...
/**
 * Created by Aleksander on 27.04.2015.
 */
public class SwipeToDismissTouchListener<SomeCollectionView extends ViewAdapter> implements
    ...
    public class RowContainer {
        ...
        final View deletingContainer;
        final View achievingContainer;
        final TextView doTextView;
        boolean dataContainerHasBeenDismissed;

        public RowContainer(ViewGroup container) throws Exception{
                this.container = container;
                dataContainer = container.getChildAt(0);
                undoContainer = container.getChildAt(1);
                doTextView = (TextView) undoContainer.findViewById(R.id.txt_do);
                deletingContainer = container.getChildAt(2);
                achievingContainer = container.getChildAt(3);
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss && mDownPosition != ListView.INVALID_POSITION) {
                    ...
                    // cancel
                    final View deletingContainer = mRowContainer.deletingContainer;
                    final View achievingContainer = mRowContainer.achievingContainer;
                    ...
                    mRowContainer.getCurrentSwipingView()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                @Override
                                public void onAnimationEnd(Animator animation) {
                                    deletingContainer.setVisibility(View.GONE);
                                    achievingContainer.setVisibility(View.GONE);
                                }
                            });
                }
                mVelocityTracker.recycle();
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    ...
                    if(!mRowContainer.dataContainerHasBeenDismissed) {
                        if (deltaX > 0) {
                            mRowContainer.achievingContainer.setVisibility(View.VISIBLE);
                            mRowContainer.deletingContainer.setVisibility(View.GONE);
                        } else {
                            mRowContainer.deletingContainer.setVisibility(View.VISIBLE);
                            mRowContainer.achievingContainer.setVisibility(View.GONE);
                        }
                    }
    ...
    private void addPendingDismiss(RowContainer dismissView, int dismissPosition) {
        ...
        dismissView.deletingContainer.setVisibility(View.GONE);
        dismissView.achievingContainer.setVisibility(View.GONE);
